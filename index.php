...
<body>
    ...
    <div id="content-body">
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="alexander-mils-lCPhGxs7pww-unsplash.jpg" class="d-block w-70 h-10" alt="..." id="img1">
                </div>
                <div class="carousel-item">
                    <img src="dmitry-demidko-eBWzFKahEaU-unsplash.jpg" class="d-block w-70 h-10" alt="..." id="img2">
                </div>
                <div class="carousel-item">
        ...
        <div class="page-about">
            <div class="page-about-glass">
                ...
                <section>
                    <p>State Bank of India (SBI) a Fortune 500 company, is an Indian Multinational, Public Sector
                        Banking and Financial services statutory body headquartered in Mumbai. The rich heritage and
                        legacy of over 200 years, accredits SBI as the most trusted Bank by Indians through generations.
    ...
    <footer>
        ...
        <div class="developer-contact">
            ...
            <a href="https://www.linkedin.com/in/arnab-sarkar-676813202/" target="blank">
                <svg x="0px" y="0px" width="20" height="20" viewBox="0,0,256,256" style="fill:#000000;">
                    <g fill="#eeeeee" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
                        stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0"
                        font-family="none" font-weight="none" font-size="none" text-anchor="none"
